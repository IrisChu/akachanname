...
<div class="content-container">
  ...
  <div class="search-group">
    <a href="result\{{$type}}\利口" class="search-icon">
    ...
    <a href="result\{{$type}}\元気" class="search-icon">
